...
```sh
droid@droidserver:~/software/Chef/ChefDK-0.19.6$ uname -r
4.4.0-42-generic
droid@droidserver:~/software/Chef/ChefDK-0.19.6$ uname -a
Linux droidserver 4.4.0-42-generic #62~14.04.1-Ubuntu SMP Fri Oct 7 23:15:48 UTC 2016 x86_64 x86_64 x86_64 GNU/Linux
```

```sh
droid@droidserver:~/software/Chef/ChefDK-0.19.6$ sudo dpkg -i chefdk_0.19.6-1_amd64.deb
